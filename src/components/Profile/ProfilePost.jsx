  ...
  return (
    <>
      ...
      >
        ...
        <Image src={post.image} alt="profile post" w={"100%"} h={"100%"} objectFit={"cover"} />
      </GridItem>
      {/* -------------------- MODAL ------------------- */}
      <Modal isOpen={isOpen} onClose={onClose} isCentered size={{ base: "3x1", md: "5xl" }}>
        <ModalOverlay />
        <ModalContent>
          <ModalCloseButton />
          <ModalBody bg={"black"} pb={5}>
            <Flex gap={4} w={{ base: "90%", sm: "70%", md: "full" }} mx={"auto"} maxH={"90vh"} minH={"50vh"}>
              ...
              <Flex
                ...
                alignItems={"center"}
              >
                <Image src={post.image} alt="profile post" />
              </Flex>
